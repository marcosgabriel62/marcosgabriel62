...
<body>	
<div>
	<form action ="administrador_fechar_pedido.php" method="get">
	<h1>Informar dados da pizza: </h1>
...
<br>
	<tr>
		<td>
			...
			<td>
				<input type="number_format" name="valorinformado"></input>
			</td>
	</tr>
		<tr>	
		<br>
		...
		<br><br>
				<td align="center">
				<input type="submit" value="Incluir valor">
				</td>
				<td align="center">
				</td>
		</tr>
