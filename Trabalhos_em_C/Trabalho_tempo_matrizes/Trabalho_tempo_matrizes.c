...
int main()
{
    ...
    MostraMatriz(N, N, Mc, " Matriz C tipo 1");
	...
	double tempoProcessamento2 = ((double)(final2-tempo2)) / (double)(CLOCKS_PER_SEC);
	MostraMatriz(N, N, Mc, " Matriz C tipo 2");
    ...
    printf("\nAll done! Tempo de processamento A: %f segundos.\n", tempoProcessamento);
    printf("\nAll done! Tempo de processamento B: %f segundos.\n", tempoProcessamento2);
    return 0;
}
